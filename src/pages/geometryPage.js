...
// ---------------------------------------------------------
const svgA1_1_1 = document.getElementById("svgA1_1_1");
if (svgA1_1_1) {
    const plane = new CartesianPlane(svgA1_1_1, -3, 15, -3, 15);
...
// ---------------------------------------------------------
const svgA1_2_1 = document.getElementById("svgA1_2_1");
if (svgA1_2_1) {
    const plane = new CartesianPlane(svgA1_2_1, -3, 15, -3, 11);
...
// ---------------------------------------------------------
const svgA1_3_1 = document.getElementById("svgA1_3_1");
if (svgA1_3_1) {
    const plane = new CartesianPlane(svgA1_3_1, -10, 10, -10, 10);
...
// ---------------------------------------------------------
const svgA1_X = document.getElementById("svgA1_X");
if (svgA1_X) {
    const plane = new CartesianPlane(svgA1_X, -10, 11, -10, 10);
