...
- [x] Considerar si se mantiene el uso de mathjs o se implementan los métodos que se necesiten en CartesianPlane y EuclideanSpace.=> Mantenemos uso de MathJS.
- [x] Crear archivo SVGDrawings.md, definiendo cómo se escriben las imágenes .svg en el proyecto.=> Se crea DrawingEngineReference.md.
